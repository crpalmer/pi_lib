LIB=lib.a
D=$(HOME)/lib
CFLAGS=-Wall -Werror -g -I../tinyalsa/include -DNO_PIGPIO_EMULATION
...
GPIO_OBJS = digital-counter.o lights.o i2c.o mcp23017.o pca9685.o \
	    pi-gpio-pi.o pi-gpio-pi-servo.o wb.o ween-board.o
MOTOR_OBJS = grove.o l298n.o
